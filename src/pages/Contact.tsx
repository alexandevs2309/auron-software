...
const info = [
  { icon: Mail, label: 'Email', value: 'hello@auronsoftware.com' },
...
export function ContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const mailto = `mailto:hello@auronsoftware.com?subject=${encodeURIComponent(subject || 'Contacto desde el sitio')}&body=${encodeURIComponent(body)}`
            ...
            >
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <p className="text-xs text-[var(--auron-text-tertiary)]">
                  El formulario abre tu cliente de correo con el mensaje listo para enviar a hello@auronsoftware.com.
                </p>
              </form>
            </motion.div>
          </div>
