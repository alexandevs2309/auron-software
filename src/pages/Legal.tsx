  ...
  return (
    <>
      ...
      sections={[
        ...
        {
          title: 'Tus derechos',
          body: 'Puedes solicitar acceso, corrección o eliminación de tus datos personales en cualquier momento escribiendo a privacy@auronsoftware.com. Responderemos en un plazo máximo de 30 días.',
        },
        {
          title: 'Contacto',
          body: 'Para cualquier consulta sobre esta política, escríbenos a privacy@auronsoftware.com o a través del formulario de contacto.',
        },
      ]}
    />
    </>
  ...
  return (
    <>
      ...
      sections={[
        ...
        {
          title: 'Contacto',
          body: 'Si tienes preguntas sobre estos términos, escríbenos a legal@auronsoftware.com.',
        },
      ]}
    />
    </>
    ...
    <>
      ...
      sections={[
        ...
        },
        {
          ...
          body: 'Si descubres una vulnerabilidad en nuestros productos, te agradecemos reportarla de forma responsable a security@auronsoftware.com. Investigamos y resolvemos con prioridad.',
        },
        {
          title: 'Contacto',
          body: 'Para asuntos de seguridad, escríbenos a security@auronsoftware.com.',
        },
      ]}
    />
    </>
