  ...
  return (
    <>
      <Seo
        ...
        description="Conoce las Editions de AURON Suite: Beauty Edition (en operación), Restaurant y Hospitality (en desarrollo), Medical y Retail (planeadas). Todas comparten un núcleo unificado con facturación DGII e-CF nativa."
        path="/products"
        jsonLd={jsonLd}
      />
        ...
        <Container className="relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-lg md:text-xl max-w-xl text-[var(--auron-text-secondary)]" style={{ lineHeight: 1.7 }}>
              ...
              <br />
              <span className="font-medium" style={{ color: 'var(--auron-accent-text)' }}>Beauty Edition ya está en operación.</span> Restaurant y Hospitality Editions están en desarrollo; Health y Retail están planeadas.
            </p>
          </div>
        </Container>
      </section>
